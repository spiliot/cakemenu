...
class CakemenuHelper extends AppHelper {
	...
	public $orientation = 'horizontal'; //could be horizontal, vertical or navbar
	...
	public function libs($type = null){
		if($type != null){
		...
		$output .= $this->Html->script('/cakemenu/js/superfish');
		$output .= $this->Html->script('/cakemenu/js/supersubs');
